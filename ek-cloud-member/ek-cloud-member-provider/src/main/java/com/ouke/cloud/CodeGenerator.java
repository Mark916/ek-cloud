...
public class CodeGenerator {
    public static final String DB_URL = "jdbc:mysql://121.41.177.68:19708/ekcloud?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true";
    public static final String USER_NAME = "root";
    public static final String PASSWORD = "IVhcwyTj";
    public static final String DRIVER = "com.mysql.jdbc.Driver";
    public static final String AUTHOR = "edison";
    //生成的文件输出到哪个目录
    public static final String OUTPUT_FILE = "D:\\codeGen";
    //包名，会按照com/example/demo这种形式生成类
    public static final String PACKAGE = "com.ouke.cloud.defaults";
...
//                .setDbColumnUnderline(true)
    ...
    public static void main(String[] args) {
        new CodeGenerator().generateByTables(false, "t_default");
    }
}
